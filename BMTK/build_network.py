...
inds = np.random.choice(np.arange(0,np.size(pos_list,0)),numPN_CP,replace=False)
pos = pos_list[inds,:]

netff.add_nodes(N=numPN_CP, pop_name='Cell_CP',
...
inds = np.random.choice(np.arange(0,np.size(pos_list,0)),numPN_CS,replace=False)
pos = pos_list[inds,:]

netff.add_nodes(N=numPN_CS, pop_name='Cell_CS',
                positions=positions_list(positions=pos),
                potental='exc',
                model_type='biophysical',
...
netff.add_edges(source={'pop_name': ['Cell_CP']}, target={'pop_name': ['Cell_Bask']},
                connection_rule=dist_conn_perc,
                connection_params={'prob':0.32,'min_dist':0.0,'max_dist':300.0,'min_syns':1,'max_syns':2},
                syn_weight=0.1,
...
netff.add_edges(source={'pop_name': ['Cell_CS']}, target={'pop_name': ['Cell_Bask']},
                connection_rule=dist_conn_perc,
                connection_params={'prob':0.22,'min_dist':0.0,'max_dist':300.0,'min_syns':1,'max_syns':2},
                syn_weight=0.1,
                #weight_function = 'Lognormal',
                #weight_sigma=0,
                dynamics_params='AMPA_ExcToInh.json',
...
netff.add_edges(source={'pop_name': 'Cell_CP'}, target={'pop_name': ['Cell_CS']},
                connection_rule=dist_conn_perc,
                connection_params={'prob':0.01,'min_dist':0.0,'max_dist':600.0,'min_syns':1,'max_syns':2},
                syn_weight=0.0000001,
                #weight_function = 'Lognormal',
                #weight_sigma=0,
...
netff.add_edges(source={'pop_name': 'Cell_CS'}, target={'pop_name': ['Cell_CP']},
                connection_rule=dist_conn_perc,
                connection_params={'prob':0.10,'min_dist':0.0,'max_dist':600.0,'min_syns':1,'max_syns':2},
                syn_weight=0.0000001,
                #weight_function = 'Lognormal',
                #weight_sigma=0,
                dynamics_params='AMPA_ExcToExc.json',
...
netff.add_edges(source={'pop_name': 'Cell_CP'}, target={'pop_name': ['Cell_CP']},
                connection_rule=dist_conn_perc,
                connection_params={'prob':0.10,'min_dist':0.0,'max_dist':600.0,'min_syns':1,'max_syns':2},
                syn_weight=0.0000001,
                #weight_function = 'Lognormal',
...
netff.add_edges(source={'pop_name': 'Cell_CS'}, target={'pop_name': ['Cell_CS']},
                connection_rule=dist_conn_perc,
                connection_params={'prob':0.10,'min_dist':0.0,'max_dist':600.0,'min_syns':1,'max_syns':2},
                syn_weight=0.00000001,
                #weight_function = 'Lognormal',
                #weight_sigma=0,
                dynamics_params='AMPA_ExcToExc.json',
                model_template='exp2syn',
...
netff.add_edges(source={'pop_name': 'Cell_Bask'}, target={'pop_name': 'Cell_CS'},
                connection_rule=dist_conn_perc,
                connection_params={'prob':0.17,'min_dist':0.0,'max_dist':300.0,'min_syns':1,'max_syns':2},
                syn_weight=0.00000001,
                weight_function = 'Lognormal',
                weight_sigma=0,
...
netff.add_edges(source={'pop_name': 'Cell_Bask'}, target={'pop_name': 'Cell_CP'},
                connection_rule=dist_conn_perc,
                connection_params={'prob':0.20,'min_dist':0.0,'max_dist':300.0,'min_syns':1,'max_syns':2},
                syn_weight=0.001,
                weight_function = 'Lognormal',
                weight_sigma=0,
                dynamics_params='GABA_InhToExc.json',
...
thalamus.add_nodes(N=numPN_CP+numPN_CS+numBask,
                   pop_name='tON',
                   potential='exc',
                   model_type='virtual')
print(thalamus.nodes)

thalamus.add_edges(source=thalamus.nodes(), target=netff.nodes(pop_name=['Cell_CP','Cell_CS']),
...
psg.add(node_ids=range(numPN_CP+numPN_CS+numBask),  # Have nodes to match mthalamus
